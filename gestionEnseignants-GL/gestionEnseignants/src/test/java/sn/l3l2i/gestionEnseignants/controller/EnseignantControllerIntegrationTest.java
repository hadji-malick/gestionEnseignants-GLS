...
public class EnseignantControllerIntegrationTest {
    ...
    public void testAjouterEnseignant() {
        // Arrange
        Enseignant enseignant = new Enseignant(null, "NdiayeBa", "cheikhna", "cheikhna.NdiayeBa@example.com");
        ...
        assertEquals("NdiayeBa", response.getBody().getNom());
    }
    ...
    public void testGetAllEnseignants() {
        ...
        Enseignant enseignant1 = new Enseignant(null, "NdiayeBa", "cheikhna", "cheikhna.NdiayeBa@example.com");
        ...
        assertEquals("NdiayeBa", firstEnseignant.getNom());
